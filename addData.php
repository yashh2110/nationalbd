 ...
 <?php
   if(isset($_POST['oldpatientbtn'])){
     ...
     if(mysqli_query($conn,$sql)){
       header("location:home.php?message=Patiant Data have been submited successfuly");
     }else{
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>NationalOpticals | AddData</title>
  </head>
  <body>
    ...
    <main>
      <div class="container-sm">
        <h3 style="font-family: 'Audiowide', cursive;"class="text-center">Add Data</h3>
      </div>

      <form class="from-group" action="addData.php" method="post">
      <!-- DETAILS -->
      <div class="container-sm bg-light">
        <div class="input-group">
          <h4 class="persondata" >MRD NO : </h4> <h4 class="historyitem"><?php
          if(isset($_POST['addthroughdashbord'])){
            echo $_POST['MRD_NO1'];
          }else{
            echo $_SESSION['mrd'];} ?></h4>
          <h4 class="persondata">NAME : </h4> <h4 class="historyitem"><?php
          if(isset($_POST['addthroughdashbord'])){
            echo $_POST['NAME'];
          }else{
        ...
        <div class="input-group">
          <h4 class="persondata">AGE :  </h4> <h4 class="historyitem"><?php
          if(isset($_POST['addthroughdashbord'])){
            echo $_POST['AGE'];
          }else{
             echo $_SESSION['age']; }  ?></h4>
          <h4 class="persondata">phone : </h4> <h4 class="historyitem"><?php
          if(isset($_POST['addthroughdashbord'])){
            echo $_POST['AGE'];
          }else{
             echo $_SESSION['phone']; }   ?></h4>
        </div>
        ...
        <table class="table table-sm table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td><input type="text" class="form-control"name="K1_OS_CYL"/></td>
              <td><input type="text" class="form-control"name="K1_OS_A"/></td>
            </tr>
            <tr>
              <td>OS</td>
              ...
              <td><input type="text" class="form-control"name="K2_OS_CYL"/></td>
              <td><input type="text" class="form-control"name="K2_OS_A"/></td>
            </tr>
          </tbody>
        </table>
      </div>
